...
TextTheme _textTheme(ColorStyles colors) {
  ...
  return textTheme.copyWith(
      titleLarge: TextStyle(color: primaryContent.withAlpha((0.8*255).round())),
      labelLarge: TextStyle(color: primaryContent.withAlpha((0.8*255).round())),
      bodySmall: TextStyle(color: primaryContent.withAlpha((0.8*255).round())),
      bodyMedium: TextStyle(color: primaryContent.withAlpha((0.8*255).round())));
}
